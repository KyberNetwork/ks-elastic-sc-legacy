...
describe('BasePositionManager Fee 2%', () => {
  ...
  describe(`#add liquidity`, async () => {
    ...
    it('add liquidity with tokens - has new fees', async () => {
      ...
      let gasUsed = BN.from(0);
      let numRuns = 5;
      let liquidityDesired = [228041, 403654, 573776, 747395, 925737];
      let amount0Desired = [62997, 91232, 116963, 145173, 176327];
      let amount1Desired = [120000, 240000, 360000, 480000, 600000];
      let additionalRTokenOwedDesired = [16393, 31758, 32119, 31086, 31581];
  ...
  describe(`#remove liquidity`, async () => {
    ...
    it('remove liquidity with tokens - has new fees', async () => {
      ...
      let gasUsed = BN.from(0);
      let numRuns = 5;
      let amount0Desired = [27, 44, 59, 74, 90];
      let amount1Desired = [52, 119, 190, 261, 331];
      let additionalRTokenOwedDesired = [16393, 32420, 31817, 31363, 30934];
