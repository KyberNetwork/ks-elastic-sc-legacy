...
let swapFeeUnitsArray = [5000];
let tickDistanceArray = [100];
...
describe('BasePositionManager Fee 5%', () => {
  ...
  describe(`#mint`, async () => {
    ...
    it('mint & create new token', async () => {
      ...
      let liquidityDesired = [20505166, 10508831];
  ...
  describe(`#add liquidity`, async () => {
    ...
    it('add liquidity with tokens - no new fees', async () => {
      ...
      let gasUsed = BN.from(0);
      let numRuns = 5;
      let liquidityDesired = [254159, 508318, 762477, 1016636, 1270796];
    ...
    it('add liquidity with tokens - has new fees', async () => {
      ...
      let gasUsed = BN.from(0);
      let numRuns = 5;
      let liquidityDesired = [229347, 406652, 578086, 752615, 931531];
      let amount0Desired = [63895, 93150, 119625, 148344, 179824];
      let amount1Desired = [120000, 240000, 360000, 480000, 600000];
      let additionalRTokenOwedDesired = [40595, 77875, 77282, 73576, 73756];
  ...
  describe(`#remove liquidity`, async () => {
    ...
    it('remove liquidity with tokens - no new fees', async () => {
      ...
      let gasUsed = BN.from(0);
      let numRuns = 5;
      let amount0Desired = [39, 78, 118, 157, 196];
      let amount1Desired = [39, 78, 118, 157, 196];
    ...
    it('remove liquidity with tokens - has new fees', async () => {
      ...
      let gasUsed = BN.from(0);
      let numRuns = 5;
      let amount0Desired = [27, 45, 60, 76, 92];
      let amount1Desired = [52, 118, 188, 259, 328];
      let additionalRTokenOwedDesired = [40595, 79461, 76357, 73732, 71293];
    ...
    it('remove liquidity, no collecting tokens', async () => {
      ...
      await expect(
        ...
        .to.be.emit(positionManager, 'RemoveLiquidity')
        .withArgs(nextTokenId, liquidity, 393, 393, 0);
